<?php
/**
 * Invoice template (simple folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap invoice kitgenix-simple">
		...
		<tr>
			...
			<td class="address shipping-address">
				<?php if ( $show_shipping ) : ?>
					...
					<p><?php echo wp_kses_post( $shipping_addr ); ?></p>
					<?php if ( $order->get_shipping_phone() ) : ?>
						<div class="shipping-phone"><?php echo esc_html( $order->get_shipping_phone() ); ?></div>
					<?php endif; ?>
				<?php else : ?>
					<h3><?php echo esc_html__( 'Ship To', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></h3>
					<p>—</p>
