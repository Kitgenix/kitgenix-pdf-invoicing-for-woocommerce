<?php
/**
 * Receipt template (simple folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap receipt kitgenix-simple">
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-brand">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-company-meta">
					<?php if ( $company_address ) : ?>
						<div class="kitgenix-pdf-invoicing-for-woocommerce-company-address"><?php echo wp_kses_post( nl2br( esc_html( $company_address ) ) ); ?></div>
					<?php endif; ?>
					...
					<?php if ( $tax_id ) : ?>
						<div class="kitgenix-pdf-invoicing-for-woocommerce-company-tax">
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-simple-addresses">
		<tr>
			...
			<td class="address shipping-address">
				<h3><?php echo esc_html__( 'Confirmation', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></h3>
				<p class="kitgenix-pdf-invoicing-for-woocommerce-confirmation-text"><?php echo esc_html__( 'Payment received for the order referenced.', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></p>
			</td>
		</tr>
	</table>
	...
	<div class="kitgenix-pdf-invoicing-for-woocommerce-simple-bottom">
		...
		<div class="kitgenix-pdf-invoicing-for-woocommerce-simple-totals">
			<table class="totals">
				<tfoot>
