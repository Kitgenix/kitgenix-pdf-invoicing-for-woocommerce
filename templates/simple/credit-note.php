<?php
/**
 * Credit Note template (simple folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap credit-note kitgenix-simple">
		...
		<tr>
			<td class="kitgenix-pdf-invoicing-for-woocommerce-brand">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-company-meta">
					...
					<?php if ( $tax_id ) : ?>
						<div class="kitgenix-pdf-invoicing-for-woocommerce-company-tax-id">
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-docmeta">
				...
				<table class="kitgenix-pdf-invoicing-for-woocommerce-meta-table">
					<tr>
						<th><?php echo esc_html__( 'Credit #', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></th>
						<td><?php echo esc_html( $credit_note_number ); ?></td>
					</tr>
					<tr>
						<th><?php echo esc_html__( 'Credit Date', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></th>
		...
		<tr>
			...
			<td class="address shipping-address">
				...
				<?php if ( $order->get_date_created() ) : ?>
					<div class="related-order-date"><?php echo esc_html( DocumentDisplay::format_order_created_date( $order, $settings ) ); ?></div>
				<?php endif; ?>
			</td>
		</tr>
	</table>
