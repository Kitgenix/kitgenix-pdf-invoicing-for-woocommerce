<?php
/**
 * Receipt template (standard folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap receipt">
	...
	<table class="order-data-addresses">
		<tr>
			...
			<td class="address shipping-address">
				...
				<p><?php echo esc_html__( 'Payment received for the order referenced.', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></p>
			</td>

			<td class="order-data">
				<table>
					<tr class="receipt-number">
						<th><?php echo esc_html__( 'Receipt Number', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></th>
						<td><?php echo esc_html( $receipt_number ); ?></td>
					</tr>
					<tr class="order-number">
						<th><?php echo esc_html__( 'Order Number', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></th>
