<?php
/**
 * Packing Slip template (standard folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap packing-slip">

	<table class="head container">
		<tr>
			<td class="header">
				<?php if ( $logo_url ) : ?>
					<div class="kitgenix-pdf-invoicing-for-woocommerce-logo"><img src="<?php echo esc_url( $logo_url ); ?>" alt="<?php echo esc_attr( $company_name ); ?>"></div>
				<?php else : ?>
			...
			<td class="shop-info">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-shop-meta">
					<?php if ( $company_address ) : ?><div class="shop-address"><?php echo wp_kses_post( nl2br( esc_html( $company_address ) ) ); ?></div><?php endif; ?>
