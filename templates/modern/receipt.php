<?php
/**
 * Receipt template (modern folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap receipt kitgenix-modern">
		...
		<tr>
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-brand">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-company">
					...
					<?php if ( $tax_id ) : ?>
						<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-company-tax-id">
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc-number"><?php echo esc_html( $receipt_number ); ?></div>
				<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc-date"><?php echo esc_html( DocumentDisplay::format_timestamp( $paid_date_ts, $settings ) ); ?></div>
			</td>
		</tr>
	</table>
	...
	<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-quickmeta">
		...
		<span class="kitgenix-pdf-invoicing-for-woocommerce-modern-quickmeta-chunk">
			<span class="kitgenix-pdf-invoicing-for-woocommerce-modern-quickmeta-label"><?php echo esc_html__( 'Payment Date', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></span>
			<span class="kitgenix-pdf-invoicing-for-woocommerce-modern-quickmeta-value"><?php echo esc_html( DocumentDisplay::format_timestamp( $paid_date_ts, $settings ) ); ?></span>
		</span>
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-modern-panels">
		<tr>
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-panel">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-panel-body">
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-panel">
				<div class="kitgenix-pdf-invoicing-for-woocommerce-panel-title"><?php echo esc_html__( 'Confirmation', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></div>
				<div class="kitgenix-pdf-invoicing-for-woocommerce-panel-body">
	...
	<!-- Order/payment info shown in the quick meta strip above. -->
	...
	<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-bottom">
		...
		<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-totals">
			<table class="totals">
				<tfoot>
