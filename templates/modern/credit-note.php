<?php
/**
 * Credit Note template (modern folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap credit-note kitgenix-modern">
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-modern-header">
		<tr>
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc-number"><?php echo esc_html( $credit_note_number ); ?></div>
				<div class="kitgenix-pdf-invoicing-for-woocommerce-modern-doc-date"><?php echo esc_html( DocumentDisplay::format_timestamp( $credit_date_ts, $settings ) ); ?></div>
			</td>
		</tr>
	</table>
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-modern-panels">
		<tr>
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-modern-panel">
				<div class="kitgenix-pdf-invoicing-for-woocommerce-panel-title"><?php echo esc_html__( 'Related Order', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></div>
				<div class="kitgenix-pdf-invoicing-for-woocommerce-panel-body">
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-modern-meta">
		<tr>
		...
		<?php foreach ( $order_data_rows as $order_data_row ) : ?>
			<tr>
				...
				<td colspan="3"><?php echo esc_html( $order_data_row['value'] ); ?></td>
			</tr>
		<?php endforeach; ?>
	</table>
