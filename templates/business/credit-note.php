<?php
/**
 * Credit Note template (business folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap credit-note kitgenix-business">
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-business-addresses">
		<tr>
			...
			<td class="kitgenix-pdf-invoicing-for-woocommerce-business-address">
				<div class="kitgenix-pdf-invoicing-for-woocommerce-business-address-title"><?php echo esc_html__( 'Related Order', 'kitgenix-pdf-invoicing-for-woocommerce' ); ?></div>
				<div class="kitgenix-pdf-invoicing-for-woocommerce-business-address-body">
					<?php echo esc_html( $order->get_order_number() ); ?>
					<?php if ( $order->get_date_created() ) : ?><div class="order-date"><?php echo esc_html( DocumentDisplay::format_order_created_date( $order, $settings ) ); ?></div><?php endif; ?>
				</div>
			</td>
		</tr>
	</table>
