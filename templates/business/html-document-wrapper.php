<?php
/**
 * HTML document wrapper (business template).
 *
 * Variables expected:
 * @var string   $content
...
$body_class = apply_filters(
	...
	'kitgenix-pdf-document kitgenix-pdf-template-business ' . sanitize_html_class( (string) $document_type ),
	$document_type,
	$order,
	$settings
);
...
$stylesheet_url = defined( 'KITGENIX_PDF_INVOICING_FOR_WOOCOMMERCE_URL' )
	? KITGENIX_PDF_INVOICING_FOR_WOOCOMMERCE_URL . 'templates/business/business-styles.css'
	: plugin_dir_url( __FILE__ ) . 'business-styles.css';
