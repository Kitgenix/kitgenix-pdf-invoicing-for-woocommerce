<?php
/**
 * Packing Slip template (business folder).
 *
 * @var WC_Order $order
 * @var array    $settings
...
?>
<div class="kitgenix-pdf-invoicing-for-woocommerce-wrap packing-slip kitgenix-business">
	...
	<table class="kitgenix-pdf-invoicing-for-woocommerce-business-addresses">
		<tr>
			<td class="kitgenix-pdf-invoicing-for-woocommerce-business-address">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-business-address-body"><?php echo wp_kses_post( $ship_to ); ?></div>
			</td>
			<td class="kitgenix-pdf-invoicing-for-woocommerce-business-address">
				...
				<div class="kitgenix-pdf-invoicing-for-woocommerce-business-address-body"><?php echo wp_kses_post( $billing_addr ); ?></div>
			</td>
		</tr>
	</table>
